...
public class SeeCurrentFriends extends JComponent implements Runnable {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new SeeCurrentFriends());  
    }
    
    @Override
    public void run() {
        SeeCurrentFriends frame = new SeeCurrentFriends();
        frame.setVisible(true);
    }

    public SeeCurrentFriends() {
        ...
        JLabel labelAllUsers = new JLabel("Corona Connect Current Friends");
        ...
        */
        ...
        JLabel lbl = new JLabel("THIS IS FRIEND LIST LOCATION");
        mPanel.add(lbl);
